...
type opg470Band struct {
	band
}

func (b *opg470Band) Name() string {
	return "OPG470"
}

func (b *opg470Band) GetDefaults() Defaults {
	return Defaults{
		RX2Frequency:     477700000,
		RX2DataRate:      0,
		MaxFCntGap:       16384,
...
func (b *opg470Band) GetDownlinkTXPower(freq int) int {
	return 14
}

func (b *opg470Band) GetDefaultMaxUplinkEIRP() float32 {
	return 19.15
}

func (b *opg470Band) GetPingSlotFrequency(devAddr lorawan.DevAddr, beaconTime time.Duration) (int, error) {
...
func (b *opg470Band) GetRX1ChannelIndexForUplinkChannelIndex(uplinkChannel int) (int, error) {
	return uplinkChannel % 48, nil
}

func (b *opg470Band) GetRX1FrequencyForUplinkFrequency(uplinkFrequency int) (int, error) {
...
func (b *opg470Band) ImplementsTXParamSetup(protocolVersion string) bool {
	return false
}

func newOPG470Band(repeaterCompatible bool) (Band, error) {
	b := opg470Band{
		band: band{
